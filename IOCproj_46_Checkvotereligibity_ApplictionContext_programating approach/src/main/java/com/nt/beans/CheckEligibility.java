...
public class CheckEligibility implements DisposableBean,InitializingBean {
	...
	public void afterPropertiesSet() throws Exception {
		System.out.println("CheckEligibility.afterproperties()");
		if(name==null || age<=0) {
			throw new IllegalArgumentException("name age must set with values");
		}
	...
	public void destroy() throws Exception {
		System.out.println("CheckEligibility.destroy()");
		name=null;
		age=0;
		addres=null;

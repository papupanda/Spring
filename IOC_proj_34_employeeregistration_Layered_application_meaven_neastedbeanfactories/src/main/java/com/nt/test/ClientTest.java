...
public class ClientTest {
	...
	public static void main(String[] args) {
        ...
        //creating parent IOC container
     BeanFactory pfactory=new XmlBeanFactory(new ClassPathResource("com/nt/cfgs/businesstier.xml"));
	  //creating child ioc container
     BeanFactory cfactory=new XmlBeanFactory(new ClassPathResource("com/nt/cfgs/presentationtier.xml"));
